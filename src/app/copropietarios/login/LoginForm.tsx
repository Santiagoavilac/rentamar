...
import { signInCoOwnerAction, type CoOwnerLoginState } from "./actions";
...
export default function CoOwnerLoginForm() {
  const [state, formAction] = useActionState<CoOwnerLoginState, FormData>(signInCoOwnerAction, {
    error: null,
  });
